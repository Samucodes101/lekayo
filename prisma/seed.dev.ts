// ==========================================
// SAFETY GUARD
// Never run this against production. Requires
// an explicit opt-in via ALLOW_DEV_SEED=true
// AND non-production NODE_ENV.
// ==========================================
if (process.env.NODE_ENV === 'production' || !process.env.ALLOW_DEV_SEED) {
  console.error(
    '❌ seed.dev.ts requires ALLOW_DEV_SEED=true and non-production NODE_ENV. Refusing to run.',
  )
  process.exit(1)
}
